...
{
public:
	Entity(float pos_x, float pos_y, float vel_x, float vel_y, float accel_x, float width, float height, bool isStatic)
...
int main(int argc, char *argv[])
{
	...
	Ground ground(0.0f, -10.0f, 30.0f, 12.0f);
